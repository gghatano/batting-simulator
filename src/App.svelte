...
<main>
  ...
  {:else}
    ...
    {#if $activeTab === 'lineup'}
      <div class="layout" role="tabpanel" id="tabpanel-lineup" aria-labelledby="tab-lineup">
        <PlayerList />
        <LineupPanel />
      </div>
    {:else}
      <div class="sim-layout" role="tabpanel" id="tabpanel-simulation" aria-labelledby="tab-simulation">
        <SimulationPanel />
        <LineupSummary />
      </div>
    {/if}
